...
## 0. Project Identity
* **Name:** Tiny Tamagotchi Simulator
* **One-line value:** Cuts autonomous UI validation latency from 24 hours to 5 minutes for interface testers — showing micro-animation states.
